                                    ...
                                    <table
                                        ...
                                        <tbody class="list form-check-all">
                                            ...
                                            <tr>
                                                ...
                                                {{-- <td>
                                                    <span>
                                                        <a href="{{ route('editor.product.edit', $products->id) }}"><img
                                                                src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                alt=""></a>
                                                    </span>
                                                </td>
                                                <td>
                                                    <a href="{{ route('editor.product.delete', $products->id) }}"><img
                                                ...
                                                <td>
                                                    <ul class="d-flex gap-2 list-unstyled mb-0">
                                                        <li>
                                                            <a href="{{ route('editor.product.edit', $products->products_id) }}"
