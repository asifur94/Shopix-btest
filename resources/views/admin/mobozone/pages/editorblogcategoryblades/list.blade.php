                                        ...
                                        <table
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td>
                                                        <span>
                                                            <a href="{{ route('editor.blogcategory.edit', $blogcategorys->id) }}"><img
                                                                    src="{{ asset('editor/assets/myImages/edit-property-24.png') }}"
                                                                    alt=""></a>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('editor.blogcategory.delete', $blogcategorys->id) }}"><img
                                                    ...
                                                    <td>
                                                        <ul class="d-flex gap-2 list-unstyled mb-0">
                                                            <li>
                                                                <a href="{{ route('editor.blogcategory.edit', $blogcategorys->blog_catagories_id) }}"
