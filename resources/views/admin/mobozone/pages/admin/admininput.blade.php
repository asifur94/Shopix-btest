...
@section('content')
    <div class=" main-content">
        <div class="row pt-5 justify-content-center">
            <div class="col-md-11">
                <form action="" method="post" name="createadminFrom" id="createadminFrom">
                    <div class="card">
                        <div class="card-header">{{ __('admin Create') }}
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <a name="" id="" class="btn btn-primary"
                                        href="{{ route('admin.admin.index') }}" role="button">Back</a>
                                </div>
...
@section('extraJs')
    <script type="text/javascript">
        ...
        $("#createadminFrom").submit(function(event) {
            event.preventDefault();

            $.ajax({
                url: "{{ route('admin.from.save') }}",
                type: 'POST',
                dataType: 'json',
                data: $("#createadminFrom").serializeArray(),
