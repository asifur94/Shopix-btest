                                ...
                                <div class="card-header">
                                    <div class="row align-items-center g-2">
                                        <div class="col-lg-3 me-auto">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h6 class="card-title mb-0">Admin List <span
                                                ...
                                                <div class="col-md-6">
                                                    <a name="" id="" class="btn btn-primary"
                                                        href="{{ route('admin.admin.create') }}" role="button">Create</a>
                                        ...
                                        <table
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if (!empty($admins->img))
                                                            <img src="{{ asset('uploads/admin/thumb/small/' . $admins->img) }}"
                                                                width="50" alt="">
                                                        @else
                                                    ...
                                                    {{-- <td>
                                                        <span>
                                                            <a href="{{ route('admin.admin.edit', $admins->id) }}"><img
                                                                    src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                    alt=""></a>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('admin.admin.delete', $admins->id) }}"><img
                                                    ...
                                                    <td>
                                                        <ul class="d-flex gap-2 list-unstyled mb-0">
                                                            <li>
                                                                <a href="{{ route('admin.admin.edit', $admins->id) }}"
                                                                    class="btn btn-subtle-secondary btn-icon btn-sm edit-item-btn"><i
                                                                        class="ph-pencil"></i></a>
                                                            </li>
                                                            <li>
                                                                <a href="{{ route('admin.admin.delete', $admins->id) }}"
