                        ...
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0 mt-n5">
                                <div class="text-center">
                                    <div class="profile-user position-relative d-inline-block mx-auto">
                                        ...
                                        @if (!empty(Auth::guard('admin')->user()->img))
                                            <img class="avatar-lg rounded-circle object-fit-cover border-0 img-thumbnail user-profile-image"
                                                src="{{ asset('uploads/admin/thumb/small/' . Auth::guard('admin')->user()->img) }}"
                                    ...
                                    <div class="mt-3">
                                        <h5>{{ Auth::guard('admin')->user()->name }} <i
                    ...
                    <div class="col-xxl-9">
                        <div class="d-flex align-items-center flex-wrap gap-2 mb-4">
                            ...
                            <div class="flex-shrink-0 ms-auto order-1 order-lg-2">
                                <a href="{{ route('admin.profile.index') }}" class="btn btn-secondary"><i
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label for="firstnameInput" class="form-label">First
                                                            Name</label>
                                                        <input value="{{ Auth::guard('admin')->user()->name }}"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="emailInput" class="form-label">Email
                                                            Address</label>
                                                        <input value="{{ Auth::guard('admin')->user()->email }}"
                                                    ...
                                                    <div class="mb-3">
                                                        <div class="from-group">
                                                            ...
                                                            <select name="status" id="status" class="form-control">
                                                                <option value="1"
                                                                    {{ Auth::guard('admin')->user()->status == 1 ? 'selected' : '' }}>
                                                                    admin</option>
                                                                <option value="0"
                                                                    {{ Auth::guard('admin')->user()->status == 0 ? 'selected' : '' }}>
                                                                    Block</option>
                                                            </select>
                                                        </div>
                                                    </div>
...
@section('extraJs')
    <script type="text/javascript">
        ...
        $("#passwordchangefromid").submit(function(event) {
            ...
            $.ajax({
                url: "{{ route('admin.chnagepass.save') }}",
                type: 'POST',
                dataType: 'json',
