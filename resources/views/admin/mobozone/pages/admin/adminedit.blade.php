...
@section('content')
    <div class=" main-content">
        <div class="row justify-content-center">
            <div class="col-md-11">
                <form action="" method="post" name="editAdminFrom" id="editAdminFrom">
                    <div class="card">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-4">
                                    <br>
                                    <a name="" id="" class="btn btn-primary" href="{{ route('admin.admin.index') }}" role="button">Back</a>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $admin->name }}" type="text" name="name" id="name" class="form-control" placeholder=""
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{ $admin->email }}" type="email" name="email" id="email" class="form-control" placeholder=""
                                    aria-describedby="helpId">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <img class="img-thumbnail mt-4 " src="{{ asset('uploads/admin/thumb/small/'.$admin->img) }}" width="300" alt="">
                            ...
                            <div class="from-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option value="1" {{ ($admin->status == 1) ? 'selected' : '' }}>admin</option>
...
@section('extraJs')
    <script type="text/javascript">
        ...
        $("#editAdminFrom").submit(function(event) {
            ...
            $.ajax({
                ...
                type: 'POST',
                dataType: 'json',
                data: $("#editAdminFrom").serializeArray(),
