                                    ...
                                    <div class="card-header">
                                        <div class="row align-items-center g-2">
                                            <div class="col-lg-3 me-auto">
                                                <h6 class="card-title mb-0">Product List<span class="badge bg-primary ms-1 align-baseline">1</span></h6>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-sm-auto">
                                                <div class="hstack gap-2">
                                                    ...
                                                    <a href="#addInstructor" id="getsingelproductstack" data-bs-toggle="modal" class="btn btn-secondary"><i class="bi bi-plus-circle align-baseline me-1"></i> Add Product Strok</a>
                                                    <a href="{{ route('admin.product.create') }}"  class="btn btn-secondary"><i class="bi bi-plus-circle align-baseline me-1"></i> Manage Product</a>
                                                </div>
                                            </div><!--end col-->
                                        </div>
                                    </div>
                                            ...
                                            <table class="table table-centered align-middle table-custom-effect table-nowrap mb-0">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="sort cursor-pointer" data-sort="instructor">Sold</th>
                                                        <th scope="col" class="sort cursor-pointer" data-sort="instructor">Stork</th>

                                                        <th scope="col" class="sort cursor-pointer" data-sort="instructor">Stock Date</th>
                                                ...
                                                <tbody class="list form-check-all">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="courses_total">{{ $product->single_products_id }}</td>
                                                        <td class="products">
                                                            <div class="d-flex align-items-center">
                                                                <div class="avatar-xs bg-light rounded p-1 me-2">
                                                                    ...
                                                                    <img width="50px" height="50px" class="img-fluid d-block" src="{{ asset('uploads/product/thumb/small/' . $product->img) }}"
                                                                         alt="">
                                                                @else
                                                                    <img class="img-fluid d-block" src="{{ asset('no_image/no_image_small.png') }}"
                                                                    width="50px" height="50px" alt="">
                                                                @endif
                                                                </div>
                                                                <div>
                                                                    <h6 class="mb-0"><a href="apps-ecommerce-product-details.html" class="text-reset products">{{ $product->name }}</a></h6>
                                                                </div>
                                                            </div>
                                                        </td>
														 ...
														 <td class="courses_total">{{ $product->stocks }}</td>

														 <td class="courses_total"> {{ date('d M Y', strtotime($product->created_at)) }}</td>
