                                        ...
                                        <table
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td>
                                                        <span>
                                                            <a href="{{ route('admin.blog.edit', $blogs->id) }}"><img
                                                                    src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                    alt=""></a>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('admin.blog.delete', $blogs->id) }}"><img
                                                    ...
                                                    <td>
                                                        <ul class="d-flex gap-2 list-unstyled mb-0">
                                                            <li>
                                                                <a href="{{ route('admin.blog.edit', $blogs->blogs_id) }}"
                                                                    class="btn btn-subtle-secondary btn-icon btn-sm edit-item-btn"><i
                                                                        class="ph-pencil"></i></a>
                                                            </li>
                                                            <li>
                                                                <a href="{{ route('admin.blog.delete', $blogs->blogs_id) }}"
