                                            ...
                                            <div class="card-header">
                                                <div class="row align-items-center g-2">
                                                    <div class="col-lg-3 me-auto">
                                                        <h6 class="card-title mb-0">Fake ORDER List <span
                                                                ...
                                                                <tbody class="list form-check-all">
                                                                    <tr>
                                                                        ...
                                                                        <td class="status"><span
                                                                                class="badge bg-danger-subtle text-danger">FAKE ORDER</span>
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            <ul class="d-flex gap-2 list-unstyled mb-0">
                                                                                ...
                                                                                <li>
                                                                                    <a href="#addInstructor2" data-bs-toggle="modal" class="btn btn-subtle-danger btn-icon btn-sm remove-item-btn"><i class="ri-printer-cloud-line"></i></a>
                                                                                </li>



                                                                                <li>
                                                                                    <a href="#addInstructor3" data-bs-toggle="modal" class="btn btn-subtle-secondary btn-icon btn-sm edit-item-btn"><i class="ri-mail-download-fill"></i></a>
                                                                                </li>
                                                                            </ul>
                                                                        </td>
                                                                    </tr>
            ...
            <div class="modal fade" id="addInstructor" tabindex="-1" aria-labelledby="addInstructorModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content border-0">
                        <div class="modal-header">
                            <h5 class="modal-title" id="addInstructorModalLabel">ORDER TRACKING ID- <input disabled="disabled" style="border: none;" id="orders_idmain"></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="customer_name"
                                                name="customer_name" value="FARHANA TANJIN MONIKA" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="customer_phone"
                                                name="customer_phone" value="01674803314" readonly>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="customer_area"
                                                name="customer_area" value="DHAKA" readonly>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="product_name"
                                                name="product_name" value="Oil Wax Man Long Wallet" readonly>
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control" id="product_price"
                                                    name="product_price" value="1200" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="cash_collection"
                                                name="cash_collection" value="800" disabled>
                                        </div>
                                    </div>
                                    <!--end col-->
