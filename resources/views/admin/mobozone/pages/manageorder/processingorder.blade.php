                                                                            ...
                                                                            <ul class="d-flex gap-2 list-unstyled mb-0">
                                                                                ...
                                                                                <li>
                                                                                    <button href="#addInstructor"
                                                                                        ...
                                                                                        value="{{ $orders->orders_id }}"
                                                                                        data-bs-toggle="modal"
                                                                                        class="btn btn-subtle-secondary btn-icon btn-sm edit-item-btn"><i class="ri-printer-cloud-line"></i></button>
                                                                                </li>
                        ...
                        <form class="tablelist-form" id="orderfromedit" novalidate autocomplete="off">
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="customer_area" class="form-label">CUSTOMER ZONE</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label for="customer_area" class="form-label">PARTICULAR ZONE</label>
                                            <select type="text" name="customer_particular_zone"
            ...
            $(document).on('click', '#getorderdid', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#customer_zone').val(response.singelorder.customer_zone);
                        $('#customer_particular_zone').val(response.singelorder.customer_particular_zone);
