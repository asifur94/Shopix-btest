                                ...
                                <div class="card-header">
                                    <div class="row align-items-center g-2">
                                        <div class="col-lg-3 me-auto">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h6 class="card-title mb-0">Heroslider List <span
                                                            class="badge bg-primary ms-1 align-baseline">
                                                            @if (!empty($totalheroslider))
                                                                {{ $totalheroslider }}
                                                            @else
                                                                0
                                                            @endif
                                        ...
                                        <table
                                            ...
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="sort cursor-pointer">Slide Name</th>
                                            ...
                                            <tbody class="list form-check-all">
                                                ...
                                                <tr>
                                                    ...
                                                    {{-- <td>
                                                        <span>
                                                            <a href="{{ route('admin.heroslider.edit', $herosliders->id) }}"><img
                                                                    src="{{ asset('admin/assets/myImages/edit-property-24.png') }}"
                                                                    alt=""></a>
                                                        </span>
                                                    </td>
                                                    <td>
                                                        <a href="{{ route('admin.heroslider.delete', $herosliders->id) }}"><img
                                                    ...
                                                    <td>
                                                        <ul class="d-flex gap-2 list-unstyled mb-0">
                                                            <li>
                                                                <a href="{{ route('admin.heroslider.edit', $herosliders->home_page_hero_slides_id) }}"
                                                                    class="btn btn-subtle-secondary btn-icon btn-sm edit-item-btn"><i
                                                                        class="ph-pencil"></i></a>
                                                            </li>
                                                            <li>
                                                                <a href="{{ route('admin.heroslider.delete', $herosliders->home_page_hero_slides_id) }}"
