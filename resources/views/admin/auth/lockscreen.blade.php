                                ...
                                <div class="card mb-0 border-0 shadow-none mb-0">
                                    <div class="card-body p-sm-5 m-lg-4">
                                        ...
                                        <div class="user-thumb text-center">
                                            ...
                                            <h5 class="font-size-15 mt-3">Hi ! {{ Auth::guard('admin')->user()->name }}</h5>
                                        </div>
                                        <div class="p-2 mt-4">
                                            <form action="{{ route('login.unlock') }}" method="GET">
                                                @csrf
                                                <div class="mb-3">
                                                    <label class="form-label" for="password">Password or Pin</label>
                                                    <input type="password" class="form-control password-input" name="password" id="password" placeholder="Enter password or pin" required>
                                                </div>
                                                <div class="mb-2 mt-4">
